  ...
  return (
    <nav className="flex fixed w-screen h-24 pt-4 z-[100]">
      <div className="flex-1 flex items-center justify-center mr-auto pl-[10rem]">
        ...
        <Link activeClass="scroll" spy={true} smooth={true} offset={-225} duration={1000} className="mx-4 cursor-pointer text-normal text-[18px] text-center font-semibold" to="EsplorazioniSuMarte">Esplorazioni su Marte</Link>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center ml-auto pr-[10rem]">
        ...
        <Link activeClass="scroll" spy={true} smooth={true} offset={-550} duration={1000} className="mx-4 cursor-pointer text-normal text-[18px] text-center font-semibold" to="Curiosità">Curiosità</Link>
      </div>
    </nav>
  )
}
