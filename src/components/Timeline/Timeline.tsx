  ...
  return (
    <div className="z-20 flex items-center justify-center">
      <div className="w-[1300px] h-[10px] relative">
        ...
        <Dialog year="1964" title="Mariner 4 - 28 novembre 1964" description="Mariner fù la prima sonda a visitare Marte, passò a 9844 km dal pianeta e scattò 22 immagini." img="https://science.nasa.gov/wp-content/uploads/2023/07/mariner_1_3_artist_impression-1280.jpg?w=1280"></Dialog>
